...
public class QuizFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.option4Btn) {
    ...
    private void resetOptions() {
        ...
        option1Btn.setBackgroundResource(R.drawable.button_bg);
        option2Btn.setBackgroundResource(R.drawable.button_bg);
        option3Btn.setBackgroundResource(R.drawable.button_bg);
        option4Btn.setBackgroundResource(R.drawable.button_bg);
    }
    ...
    private void verifyAnswer(Button button){
        if (canAnswer){
            if (answer.equals(button.getText())){
                button.setBackgroundResource(R.drawable.answer_true);
                correctAnswer++;
                ansFeedBackTv.setText("Correct Answer");
            }else{
                button.setBackgroundResource(R.drawable.answer_false);
                wrongAnswer++;
